...
{
    public class MultiplayerNetworkManager : NetworkRoomManager
    {
        ...
        public NetworkGamePlayer gamePlayerPrefab;

        public GameObject playerSpawnSystem;

        public List<NetworkRoomPlayerLobby> lobbyPlayers = new List<NetworkRoomPlayerLobby>();
        ...
        private bool IsReadyToStart()
        {
            ...
            foreach (var item in lobbyPlayers) if (item.readyToBegin == false) return false;
        ...
        public void StartGame()
        {
            if (SceneManager.GetActiveScene().path == menuScene)
            {
                ...
                ServerChangeScene(levels[Random.Range(0, levels.Length)]); // We should instead pick a map here
            }
        }
        ...
        public override void OnServerSceneChanged(string sceneName)
        {
            ...
            {
                var spawnerInstance = Instantiate(playerSpawnSystem);
        ...
        public override void OnServerAddPlayer(NetworkConnection conn)
        {
            if (SceneManager.GetActiveScene().path == menuScene)
            {
                ...
                var roomPlayerInstance = (NetworkRoomPlayerLobby)Instantiate(roomPlayerPrefab);
        ...
        #endregion Server System Callbacks
        ...
        #endregion Client System Callbacks
