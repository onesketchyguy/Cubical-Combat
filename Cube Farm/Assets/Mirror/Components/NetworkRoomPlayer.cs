...
namespace Mirror
{
    ...
    {
        private static readonly ILogger logger = LogFactory.GetLogger(typeof(NetworkRoomPlayer));
        ...
        /// </summary>
        /// <param name="newValue">New Ready State</param>
        public virtual void ReadyStateChanged(bool oldValue, bool newValue) { }
