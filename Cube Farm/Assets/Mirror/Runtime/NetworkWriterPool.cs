...
namespace Mirror
{
    ...
    {
        private static readonly ILogger logger = LogFactory.GetLogger(typeof(NetworkWriterPool), LogType.Error);
        ...
        private static PooledNetworkWriter[] pool = new PooledNetworkWriter[100];
