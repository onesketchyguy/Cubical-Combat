...
namespace Mirror
{
    ...
    internal class LocalConnectionBuffer
    {
        ...
        private readonly NetworkReader reader = new NetworkReader(default(ArraySegment<byte>));
    ...
    {
        private static readonly ILogger logger = LogFactory.GetLogger(typeof(ULocalConnectionToClient));
